                    ...
                    <div className="card ms-3">
                        <div className="card-body" >
                            ...
                            <div className="btn-group">
                                <span>Status: &nbsp;</span>
                                <button className="btn btn-success:danger dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    {e.status === 'Completed' ? 'Completed' : 'Not Completed'}
                                </button>

                                <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">

                                    <li><a style={{color:"green"}} className="dropdown-item btn btn-success" href="#" onClick={() => handleToggle(e.id, "Completed")}>Completed</a></li>
                                    <li><a style={{color:"red"}} className="dropdown-item btn btn-danger" href="#" onClick={() => handleToggle(e.id, "Not Completed")}>Not completed</a></li>
                                </ul>
                            </div>
                        </div>
