...
function Header({ data, setData }) {
    ...
    return (
        <div className="container mt-5">
            <h3 style={{ color:"green", textAlign:"center" }}> My toDo</h3>
                ...
                <div className="col-md-6 text-center">
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li><a className="dropdown-item btn btn-danger" href="#" onClick={() => handleFilter("All")}>All</a></li>
                            <li><a style={{color:"green"}} className="dropdown-item btn btn-success" href="#" onClick={() => handleFilter("Completed")}>Completed</a></li>
                            <li><a style={{color:"red"}} className="REDD dropdown-item btn btn-danger" href="#" onClick={() => handleFilter("Not Completed")}>Not completed</a></li>
                        </ul>
                    </div>
                </div>
            </div>
